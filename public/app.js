...
function KindSwitch({
  ...
  return React.createElement("div", {
    ...
    return React.createElement("button", {
      ...
      role: "tab",
      "aria-selected": on,
      onClick: () => !on && onChange && onChange(o.id),
      style: {
        flex: 1,
        padding: "9px 0",
        borderRadius: 99,
        ...
        background: on ? cssVar("--card") : "transparent",
...
function Home({
  ...
  const monthIncome = useMemo(() => incomes.filter(i => monthOf(i.date) === month).reduce((s, i) => s + i.amount, 0), [incomes, month]);
  ...
  }, diff > 0 ? "▲" : "▼", " ", Math.abs(diff).toFixed(0), "% so với tháng trước (", short(prevTotal), ")")), tracksMoney && React.createElement("section", {
    className: "grid2",
    style: {
      marginBottom: 20
    }
  ...
  }, "Thu nhập tháng"), React.createElement("div", {
    className: "num",
    style: {
      fontSize: 20,
      fontWeight: 600,
  ...
  }, monthIncome > 0 ? "+" + short(monthIncome) : "0"), React.createElement("div", {
  ...
  }, monthIncome > 0 ? "xem chi tiết" : "chưa ghi khoản thu")), React.createElement("button", {
    className: "box",
    onClick: () => goTab("cards"),
    style: {
      padding: 14,
  ...
  }, "Còn lại sau chi"), React.createElement("div", {
    className: "num",
    style: {
      fontSize: 20,
      fontWeight: 600,
  ...
  }, monthIncome - total < 0 ? "−" : "", short(Math.abs(monthIncome - total))), React.createElement("div", {
    className: "num truncate",
    style: {
      fontSize: 11,
      color: cssVar("--muted"),
...
function Entry({
  ...
  return React.createElement(Sheet, {
    ...
    onClose: onClose
  }, !initial && onSwitch && React.createElement(KindSwitch, {
    value: "expense",
    onChange: onSwitch
    ...
    onChange: m => {
      setMethod(m);
      setAccountId(defaultAccount(data.accounts, m));
    }
  ...
  }, "Chưa có thẻ nào. Thêm thẻ ở tab Thẻ để theo dõi dư nợ."), method !== "card" && accountsFor(data.accounts, method).length > 0 && React.createElement(Field, {
    label: "Trừ từ tài khoản"
  }, React.createElement(Chips, {
    options: [...accountsFor(data.accounts, method).map(a => ({
      id: a.id,
      label: a.name
    })), {
      id: "",
...
function PayCard({
  ...
  }, "Tối thiểu 5%"))), payFrom.length > 0 && React.createElement(Field, {
    label: "Trả từ tài khoản"
  }, React.createElement(Chips, {
...
function Accounts({
  ...
  return React.createElement("div", null, React.createElement("div", {
  ...
  }, "Tài sản ròng"), React.createElement("div", {
    className: "num hero-num",
    style: {
      fontSize: 34,
      fontWeight: 700,
  ...
  }, money(net)), React.createElement("div", {
    className: "num",
    style: {
      fontSize: 12,
      color: cssVar("--muted"),
  ...
  }, "Tài khoản"), active.length === 0 ? React.createElement(Empty, {
    text: "Chưa có tài khoản nào. Thêm tiền mặt, tài khoản ngân hàng hay sổ tiết kiệm để app tự tính số dư.",
    action: React.createElement(Button, {
      onClick: () => setAdding(true)
    }, "Thêm tài khoản")
  }) : React.createElement("div", {
  ...
  }, active.map(a => React.createElement(RowButton, {
    key: a.id,
  ...
  }, kindLabel(a.kind), a.is_default ? ", mặc định" : "", a.kind === "saving" && a.rate ? `, ${a.rate}%/năm` : "", a.kind === "saving" && a.maturity ? `, đáo hạn ${fmtDate(a.maturity)}` : "")), React.createElement("span", {
    style: {
      textAlign: "right",
      flexShrink: 0
    }
    ...
    style: {
      ...
      fontSize: 15,
      fontWeight: 600,
      color: a.balance < 0 ? cssVar("--red") : cssVar("--ink")
    }
  }, money(a.balance)), a.est_interest ? React.createElement("span", {
    className: "num",
    style: {
      fontSize: 11,
      color: cssVar("--green")
    ...
    right: incomeTotal > 0 && React.createElement("span", {
      className: "num",
      style: {
        fontSize: 13,
        fontWeight: 600,
  ...
  }, "Thu nhập ", MONTH_VN(month).toLowerCase()), monthIncomes.length === 0 ? React.createElement(Empty, {
    text: "Chưa ghi khoản thu nào trong tháng này.",
    action: React.createElement(Button, {
  ...
  }, monthIncomes.map(i => React.createElement(RowButton, {
    key: i.id,
  ...
  }, i.note || sourceLabel(i.source)), React.createElement("span", {
    className: "num truncate",
    style: {
      display: "block",
      fontSize: 11,
  ...
  }, DAY_VN(i.date), ", ", sourceLabel(i.source).toLowerCase(), i.account_id ? `, vào ${accName(i.account_id)}` : "")), React.createElement("span", {
    className: "num",
    style: {
      fontSize: 14,
      fontWeight: 600,
  ...
  }, React.createElement(SectionLabel, null, "Chuyển tiền gần đây"), React.createElement("div", {
    style: {
      marginTop: 10
    }
  }, transfers.map(t => React.createElement("div", {
    key: t.id,
    className: "tape between",
    style: {
      padding: "10px 0",
  ...
  }, accName(t.from_account), " sang ", accName(t.to_account)), React.createElement("span", {
    className: "num truncate",
    style: {
      display: "block",
      fontSize: 11,
  ...
  }, DAY_VN(t.date), t.note ? `, ${t.note}` : "")), React.createElement("span", {
    className: "row",
    style: {
      gap: 12,
      flexShrink: 0
  ...
  }, short(t.amount)), confirmId === t.id ? React.createElement("button", {
    onClick: () => delTransfer(t),
    style: {
      fontSize: 12,
      color: cssVar("--red"),
      fontWeight: 600
    }
  }, "Xóa thật") : React.createElement("button", {
    ...
    reload: reload,
    flash: flash
  })), (adding || editing) && React.createElement(AccountForm, {
    initial: editing,
    flash: flash,
    onClose: () => {
      setAdding(false);
...
function AccountForm({
  ...
  const submit = async () => {
    ...
    try {
      const body = {
        ...
        is_default: kind !== "saving" && isDefault,
        note: note.trim()
      };
      if (initial) await api("/accounts/" + initial.id, {
        method: "PUT",
        body
      });else await api("/accounts", {
        method: "POST",
        body
      });
  ...
  const remove = async () => {
    setBusy(true);
    try {
      const r = await api("/accounts/" + initial.id, {
        method: "DELETE"
      });
  ...
  return React.createElement(Sheet, {
    ...
    value: name,
    autoFocus: !initial,
    placeholder: "Techcombank lương, Ví tiền mặt, Sổ tiết kiệm VCB…",
    onChange: e => setName(e.target.value)
  })), React.createElement(Field, {
    label: "Loại"
  }, React.createElement(Chips, {
    ...
    value: opening,
    onChange: e => setOpening(e.target.value)
  }), Number(opening) > 0 && React.createElement("div", {
    className: "num",
    style: {
      fontSize: 12,
      color: cssVar("--muted"),
  ...
  }, money(Number(opening)))), React.createElement(Field, {
    label: "Bắt đầu theo dõi từ ngày"
  }, React.createElement("input", {
    className: "field num",
    type: "date",
    value: openingDate,
  ...
  })), kind === "saving" && React.createElement("div", {
    className: "grid2",
    style: {
      marginBottom: 18
    }
  ...
  }, "Lãi suất %/năm"), React.createElement("input", {
    className: "field num",
    type: "number",
    inputMode: "decimal",
    step: "0.01",
  ...
  }, "Ngày đáo hạn"), React.createElement("input", {
    className: "field num",
    type: "date",
    value: maturity,
    onChange: e => setMaturity(e.target.value)
  }))), kind !== "saving" && React.createElement(Field, {
    label: "Tài khoản mặc định",
    hint: `Khoản chi trả bằng ${methodWord} sẽ tự trừ vào tài khoản này.`
  }, React.createElement(Chips, {
    options: [{
      id: "yes",
      label: "Có"
  ...
  }, busy ? "Đang lưu…" : initial ? "Cập nhật" : "Thêm tài khoản")), initial && React.createElement("div", {
    style: {
      textAlign: "center",
      marginTop: 16
    }
  ...
  }, "Xóa tài khoản? Nếu đã có giao dịch, tài khoản sẽ được ẩn thay vì xóa.", " ", React.createElement("button", {
    onClick: remove,
    style: {
      color: cssVar("--red"),
      fontWeight: 600
...
function IncomeEntry({
  ...
  return React.createElement(Sheet, {
    title: initial ? "Sửa khoản thu" : "Ghi thu nhập",
    onClose: onClose
  }, !initial && React.createElement(KindSwitch, {
    value: "income",
    onChange: onSwitch
  ...
  }, "Chưa có tài khoản nào. Thêm ở tab Tài khoản để số dư tự cộng khi có thu nhập."), React.createElement(Field, {
    label: "Ghi chú"
  }, React.createElement("input", {
    className: "field",
    value: note,
    placeholder: "Lương tháng 9, thưởng quý…",
    onChange: e => setNote(e.target.value)
  })), React.createElement(Field, {
    label: "Ngày"
  }, React.createElement("input", {
  ...
  }, busy ? "Đang lưu…" : initial ? "Cập nhật" : "Lưu khoản thu")), initial && React.createElement("div", {
    style: {
      textAlign: "center",
      marginTop: 16
    }
  ...
  }, "Xóa khoản thu này?", " ", React.createElement("button", {
    onClick: remove,
    style: {
      color: cssVar("--red"),
      fontWeight: 600
...
function TransferEntry({
  ...
  return React.createElement(Sheet, {
    ...
    className: "field",
    value: note,
    placeholder: "Rút ATM, gửi tiết kiệm 6 tháng…",
    onChange: e => setNote(e.target.value)
  })), React.createElement(Field, {
    label: "Ngày"
  }, React.createElement("input", {
    ...
    onClick: submit,
    disabled: busy || amountNum <= 0 || !from || !to,
    style: {
      flex: 1
    }
...
function useScreenLock(enabled) {
  ...
  useEffect(() => {
    ...
    su_kien.forEach(e => window.addEventListener(e, cham, {
      passive: true
    }));
    const doiTrangThai = () => {
      if (document.hidden && cfg.khoa_khi_an) setLocked(true);else if (!document.hidden && !locked) dem();
    };
...
function LockScreen({
  ...
  return React.createElement("div", {
  ...
  }, "Sổ Chi đã khóa"), React.createElement("div", {
    style: {
      fontSize: 13,
      color: cssVar("--muted"),
      marginBottom: 28,
  ...
  }, dungMatKhau ? "Nhập mật khẩu đăng nhập để mở" : "Nhập mã PIN để mở khóa"), !dungMatKhau ? React.createElement(React.Fragment, null, React.createElement("div", {
    style: {
      display: "flex",
      gap: 12,
      marginBottom: 24
    ...
    onKeyDown: e => e.key === "Enter" && pw && thu({
      password: pw
    }),
    style: {
      width: "100%",
  ...
  }, "Mở khóa")), err && React.createElement("div", {
    style: {
      color: cssVar("--red"),
      fontSize: 13,
      marginTop: 20,
  ...
  }, err), !dungMatKhau && React.createElement("button", {
    onClick: () => {
      setDungMatKhau(true);
      setErr("");
    },
...
function LockSettings({
  ...
  return React.createElement(Sheet, {
  ...
  }, "Che màn hình khi bạn rời máy một lúc, để người khác cầm điện thoại lên không đọc được số dư. Đây là lớp che mắt, không phải lớp bảo mật — ai lấy được máy đang đăng nhập vẫn có cách lấy dữ liệu."), cfg && cfg.co_pin ? React.createElement(React.Fragment, null, React.createElement("div", {
    className: "box",
    style: {
      padding: 14,
      marginBottom: 18,
  ...
  }, "Đã đặt mã PIN")), React.createElement(Field, {
    label: "Khóa sau khi không đụng tới"
  }, React.createElement(Chips, {
    value: phut,
    onChange: v => {
      setPhut(v);
  ...
  }, "Khóa ngay khi thoát ra"), React.createElement("div", {
    style: {
      fontSize: 11,
      color: cssVar("--muted"),
      lineHeight: 1.6,
  ...
  }, "Chuyển sang app khác là khóa luôn. Nên bật, vì Android lưu ảnh màn hình cuối để hiện trong danh sách app đang chạy.")), React.createElement("input", {
    type: "checkbox",
    checked: anHien,
    onChange: e => {
      setAnHien(e.target.checked);
      luuCaiDat(phut, e.target.checked);
    }
  })), React.createElement("div", {
    style: {
      marginTop: 24,
  ...
  }, "Gỡ mã PIN"), React.createElement(Field, {
  ...
  }, "Gỡ mã PIN"))) : React.createElement(React.Fragment, null, React.createElement(Field, {
    label: "Mã PIN mới",
    hint: "4 đến 6 chữ số"
  }, React.createElement("input", {
    inputMode: "numeric",
    ...
    onClick: luuPin,
    disabled: busy || !pin || !pin2 || !pw,
    style: {
      width: "100%"
    }
  }, "Đặt mã PIN"), React.createElement("div", {
    style: {
      fontSize: 11,
      color: cssVar("--muted"),
      lineHeight: 1.6,
  ...
  }, "Quên PIN thì mở khóa bằng mật khẩu đăng nhập. Sai PIN 5 lần liên tiếp cũng sẽ phải dùng mật khẩu."))));
}
function Reports({
  month,
  setMonth,
...
function Settings({
  ...
  }, React.createElement(SectionLabel, null, "Khóa màn hình"), React.createElement("button", {
    onClick: onOpenLock,
    className: "box between",
    style: {
      padding: 14,
  ...
  }, lockCfg && lockCfg.co_pin ? "Đang bật" : "Chưa đặt mã PIN"), React.createElement("div", {
    style: {
      fontSize: 11,
      color: cssVar("--muted"),
      marginTop: 3
    }
  }, lockCfg && lockCfg.co_pin ? lockCfg.phut_cho ? `Khóa sau ${lockCfg.phut_cho} phút không dùng` + (lockCfg.khoa_khi_an ? ", và khi thoát ra" : "") : lockCfg.khoa_khi_an ? "Chỉ khóa khi thoát ra" : "Không tự khóa" : "Che số dư khi bạn rời máy")), React.createElement("span", {
    style: {
      color: cssVar("--muted")
    }
  }, "›"))), React.createElement("section", {
...
function App() {
  ...
  const loadAll = useCallback(async () => {
    const [boot, tx, inc] = await Promise.all([api("/bootstrap"), api("/transactions?limit=2000"), api("/incomes?limit=2000")]);
    setData(boot);
  ...
  return React.createElement("div", null, React.createElement("div", {
  ...
  }, (tab === "home" || tab === "cards") && React.createElement(Button, {
    onClick: () => setEntry({
      kind: tab === "cards" ? "income" : "expense"
    }),
    style: {
      padding: "9px 18px",
      fontSize: 14
    ...
    reload: reload,
    flash: flash
  }), tab === "cards" && React.createElement(Accounts, {
    data: data,
    month: month,
    incomes: incomes,
    reload: reload,
    ...
    onDone: onMoneySaved
  }), entry && entry.kind === "transfer" && React.createElement(TransferEntry, {
    data: data,
    flash: flash,
    onSwitch: kind => setEntry({
      kind
    ...
    onClose: () => setEntry(null),
    onDone: onMoneySaved
  }), entry && entry.kind !== "income" && entry.kind !== "transfer" && React.createElement(Entry, {
    data: data,
    initial: entry.initial,
    prefill: entry.prefill,
    flash: flash,
